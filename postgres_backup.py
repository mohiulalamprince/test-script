...
BACKUP_DIR = "/home/mohiulalamprince/work/python/backup/"
dumper = """ "/usr/lib/postgresql/9.1/bin/pg_dump" -U %s -Z 9 -f %s -F c %s  """                  
...
for database_name in database_list :
    database_name = str(database_name.strip())
    if str(database_name.strip()) == 'crowdcoop-test-server':
